                ...
                >
                  <Link
                    ...
                    style={{
                      ...
                      width: '100%',
                      padding: '6px 0',
                      color: isActive && !isCartItem ? 'var(--accent-primary)' : 'var(--text-secondary)',
                      position: 'relative',
                    }}
                  >
                    <div style={{ position: 'relative' }}>
                      <Icon size={24} strokeWidth={isActive && !isCartItem ? 2.5 : 2} />
                    ...
                    <span style={{ fontSize: '0.6rem', fontWeight: isActive && !isCartItem ? 700 : 500 }}>
                      {item.name}
                    </span>
                  </Link>
                </div>
